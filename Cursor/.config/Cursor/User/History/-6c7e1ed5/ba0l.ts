...
export const evaluacionPlanificacionSteps: Step[] = [
    ...
    {
		element: "#agregar-comision",
		popover: {
			title: "Agregar Comisión",
			description:
				"Permite agregar más comisiones en caso de que se cuente con gran cantidad de alumnos.",
		},
	},
    {
		element: "#guardar-comisiones",
		popover: {
			title: "Guardar Comisiones",
			description:
				"Una vez que se comprueba la factibilidad de la planificación de la práctica permite guardar las comisiones, asignandoles el estado de En Espera hasta que comience la práctica de las comisiones. A partir de ese momento pasa a estado En Curso y, una vez finalizadas, pasan a estado Finalizado.",
		},
	},
