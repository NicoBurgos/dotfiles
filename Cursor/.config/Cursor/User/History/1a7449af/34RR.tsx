...
const ComisionForm = ({
	...
	return (
		<div className="bg-white p-5 rounded-lg shadow-sm mb-2">
			...
			<div className="flex space-x-4 mb-6" id="fecha-inicio-fin">
			...
			{/* Hora Inicio y Fin */}
			<div className="flex space-x-4 mb-6 " id="hora-inicio-fin">
				<div className="w-full">
					<label className="block font-semibold text-gray-700 mb-2">
						Hora Inicio:
						<input
			...
			<div className="flex space-x-4 mb-6 " id="docente-responsable-contacto">
				{/* Docente Responsable */}
				<div className="w-full">
					<label className="block font-semibold text-gray-700 mb-3">
						Docente Responsable:
