<script>
  ...
  async function loadPortfolio() {
    loading = true;
    try {
      const res = await fetch('http://backend:8080/portfolio');
    ...
    {:else}
      ...
      {#if activeTab === 'overview'}
        <div class="overview">
          <div class="chart-container">
            ...
            <Chart client:only data={portfolio} />
          </div>
      ...
      {#if activeTab === 'history'}
        <div class="history-view">
          ...
          <p>Próximamente: Historial detallado de todas tus compras y ventas</p>
        </div>
      {/if}
    {/if}
  </main>
        ...
        <div class="modal-content">
          <form on:submit|preventDefault>
            <div class="form-group">
              ...
              <input type="text" id="asset" placeholder="Ej: BTC, AAPL, ETH" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" id="qty" step="0.00000001" placeholder="0.00000000" required>
            </div>
